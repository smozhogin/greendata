...
**Самые редкие символы в датасете -  цифры, "й", различные математические операторы, а также скобки
...
### Анализ ошибок
![Описание изображения](./графики/рез_м1.jpg)
![Описание изображения](./графики/рез_м2.jpg)
...
+ Tesseract на рукописном датасете работает плохо: CER ≈ 1, WER ≈ 0.99, Exact match ≈ 0. То есть модель почти никогда не угадывает слово полностью и сильно ошибается по символам/словам.
...
CER вырос до ≈ 0.50,WER вырос до ≈ 1,Exact match упал до ≈ 0.14.Это означает, что дообучение привело к деградации и модель стала предсказывать существенно хуже, чем исходная.
...
## Характеристики Trocr

+ Пиковый объём видеопамяти для инференса - **5.4 GB VRAM**

+ Кол-во параметров модели **0.3B**
